...
func axpyBatch16(
	...
	for ; i+16 <= width; i += 16 {
		...
		for ; k+4 <= n; k += 4 {
			...
			yv2 = archsimd.BroadcastFloat32x16(a[0][k+2]).MulAdd(wv0, yv2)
			yv3 = archsimd.BroadcastFloat32x16(a[0][k+3]).MulAdd(wv0, yv3)
			yv0 = archsimd.BroadcastFloat32x16(a[1][k]).MulAdd(wv1, yv0)
			yv1 = archsimd.BroadcastFloat32x16(a[1][k+1]).MulAdd(wv1, yv1)
			yv2 = archsimd.BroadcastFloat32x16(a[1][k+2]).MulAdd(wv1, yv2)
			yv3 = archsimd.BroadcastFloat32x16(a[1][k+3]).MulAdd(wv1, yv3)
			yv0 = archsimd.BroadcastFloat32x16(a[2][k]).MulAdd(wv2, yv0)
			yv1 = archsimd.BroadcastFloat32x16(a[2][k+1]).MulAdd(wv2, yv1)
			yv2 = archsimd.BroadcastFloat32x16(a[2][k+2]).MulAdd(wv2, yv2)
			yv3 = archsimd.BroadcastFloat32x16(a[2][k+3]).MulAdd(wv2, yv3)
			yv0 = archsimd.BroadcastFloat32x16(a[3][k]).MulAdd(wv3, yv0)
			yv1 = archsimd.BroadcastFloat32x16(a[3][k+1]).MulAdd(wv3, yv1)
			yv2 = archsimd.BroadcastFloat32x16(a[3][k+2]).MulAdd(wv3, yv2)
			yv3 = archsimd.BroadcastFloat32x16(a[3][k+3]).MulAdd(wv3, yv3)
			yv0 = archsimd.BroadcastFloat32x16(a[4][k]).MulAdd(wv4, yv0)
			yv1 = archsimd.BroadcastFloat32x16(a[4][k+1]).MulAdd(wv4, yv1)
			yv2 = archsimd.BroadcastFloat32x16(a[4][k+2]).MulAdd(wv4, yv2)
			yv3 = archsimd.BroadcastFloat32x16(a[4][k+3]).MulAdd(wv4, yv3)
			yv0 = archsimd.BroadcastFloat32x16(a[5][k]).MulAdd(wv5, yv0)
			yv1 = archsimd.BroadcastFloat32x16(a[5][k+1]).MulAdd(wv5, yv1)
			yv2 = archsimd.BroadcastFloat32x16(a[5][k+2]).MulAdd(wv5, yv2)
			yv3 = archsimd.BroadcastFloat32x16(a[5][k+3]).MulAdd(wv5, yv3)
			yv0 = archsimd.BroadcastFloat32x16(a[6][k]).MulAdd(wv6, yv0)
			yv1 = archsimd.BroadcastFloat32x16(a[6][k+1]).MulAdd(wv6, yv1)
			yv2 = archsimd.BroadcastFloat32x16(a[6][k+2]).MulAdd(wv6, yv2)
			yv3 = archsimd.BroadcastFloat32x16(a[6][k+3]).MulAdd(wv6, yv3)
			yv0 = archsimd.BroadcastFloat32x16(a[7][k]).MulAdd(wv7, yv0)
			yv1 = archsimd.BroadcastFloat32x16(a[7][k+1]).MulAdd(wv7, yv1)
			yv2 = archsimd.BroadcastFloat32x16(a[7][k+2]).MulAdd(wv7, yv2)
			yv3 = archsimd.BroadcastFloat32x16(a[7][k+3]).MulAdd(wv7, yv3)
			yv0 = archsimd.BroadcastFloat32x16(a[8][k]).MulAdd(wv8, yv0)
			yv1 = archsimd.BroadcastFloat32x16(a[8][k+1]).MulAdd(wv8, yv1)
			yv2 = archsimd.BroadcastFloat32x16(a[8][k+2]).MulAdd(wv8, yv2)
			yv3 = archsimd.BroadcastFloat32x16(a[8][k+3]).MulAdd(wv8, yv3)
			yv0 = archsimd.BroadcastFloat32x16(a[9][k]).MulAdd(wv9, yv0)
			yv1 = archsimd.BroadcastFloat32x16(a[9][k+1]).MulAdd(wv9, yv1)
			yv2 = archsimd.BroadcastFloat32x16(a[9][k+2]).MulAdd(wv9, yv2)
			yv3 = archsimd.BroadcastFloat32x16(a[9][k+3]).MulAdd(wv9, yv3)
			yv0 = archsimd.BroadcastFloat32x16(a[10][k]).MulAdd(wv10, yv0)
			yv1 = archsimd.BroadcastFloat32x16(a[10][k+1]).MulAdd(wv10, yv1)
			yv2 = archsimd.BroadcastFloat32x16(a[10][k+2]).MulAdd(wv10, yv2)
			yv3 = archsimd.BroadcastFloat32x16(a[10][k+3]).MulAdd(wv10, yv3)
			yv0 = archsimd.BroadcastFloat32x16(a[11][k]).MulAdd(wv11, yv0)
			yv1 = archsimd.BroadcastFloat32x16(a[11][k+1]).MulAdd(wv11, yv1)
			yv2 = archsimd.BroadcastFloat32x16(a[11][k+2]).MulAdd(wv11, yv2)
			yv3 = archsimd.BroadcastFloat32x16(a[11][k+3]).MulAdd(wv11, yv3)
			yv0 = archsimd.BroadcastFloat32x16(a[12][k]).MulAdd(wv12, yv0)
			yv1 = archsimd.BroadcastFloat32x16(a[12][k+1]).MulAdd(wv12, yv1)
			yv2 = archsimd.BroadcastFloat32x16(a[12][k+2]).MulAdd(wv12, yv2)
			yv3 = archsimd.BroadcastFloat32x16(a[12][k+3]).MulAdd(wv12, yv3)
			yv0 = archsimd.BroadcastFloat32x16(a[13][k]).MulAdd(wv13, yv0)
			yv1 = archsimd.BroadcastFloat32x16(a[13][k+1]).MulAdd(wv13, yv1)
			yv2 = archsimd.BroadcastFloat32x16(a[13][k+2]).MulAdd(wv13, yv2)
			yv3 = archsimd.BroadcastFloat32x16(a[13][k+3]).MulAdd(wv13, yv3)
			yv0 = archsimd.BroadcastFloat32x16(a[14][k]).MulAdd(wv14, yv0)
			yv1 = archsimd.BroadcastFloat32x16(a[14][k+1]).MulAdd(wv14, yv1)
			yv2 = archsimd.BroadcastFloat32x16(a[14][k+2]).MulAdd(wv14, yv2)
			yv3 = archsimd.BroadcastFloat32x16(a[14][k+3]).MulAdd(wv14, yv3)
			yv0 = archsimd.BroadcastFloat32x16(a[15][k]).MulAdd(wv15, yv0)
			yv1 = archsimd.BroadcastFloat32x16(a[15][k+1]).MulAdd(wv15, yv1)
			yv2 = archsimd.BroadcastFloat32x16(a[15][k+2]).MulAdd(wv15, yv2)
			yv3 = archsimd.BroadcastFloat32x16(a[15][k+3]).MulAdd(wv15, yv3)
